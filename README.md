...
| **Type of Analysis**             | **Focus & Concept**                                                                       | **Pros ✅**                                                                                                                            | **Cons ⚠️**                                                                                                                             | **Common Tools 🧰**                                                                                                    | **Ideal Trader Type 👤**                                                                 |
| -------------------------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| **🟦 Technical Analysis (TA)**   | Studies **price movements**, charts, and historical data to forecast future price action. | • Clear visual signals (patterns, trends)<br>• Works on any time frame<br>• Objective & data-driven<br>• Useful for short-term timing | • Ignores fundamentals<br>• Can give false signals in volatile markets<br>• Requires discipline to interpret correctly                  | Chart patterns (head & shoulders, triangles), moving averages, RSI, MACD, Fibonacci retracements, candlestick patterns | **Scalpers**, **day traders**, **swing traders** who prefer charts and technical setups  |
